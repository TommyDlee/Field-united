      ...
      <div className="container mx-auto">
        ...
        <div className="mt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <a 
              href="https://t.me/FieldUnitedLabs"
              target="_blank" 
              rel="noopener noreferrer"
              className="card bg-[#229ED9]/20 hover:bg-[#229ED9]/30 transition-colors"
            >
              <div className="flex items-center mb-4">
                <svg className="w-8 h-8 mr-3" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <p className="text-gray-300 mb-4">
                Join our Telegram channel for announcements and community chat.
              </p>
              <span className="text-primary">Join Telegram →</span>
            </a>
          </div>
        </div>
        ...
        <div className="mt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="card">
              ...
              <p className="text-gray-300 mb-4">
                Comprehensive documentation for integrating with the FIELD ecosystem APIs.
              </p>
            ...
            <div className="card">
              ...
              <p className="text-gray-300 mb-4">
                Explore and integrate with FIELD's open-source smart contracts.
              </p>
              <ul className="space-y-2 mb-4">
                <li className="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-primary mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
